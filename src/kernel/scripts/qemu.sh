...
$AS $ASFLAGS "$PROJECT_ROOT/src/idt.asm" -o idt.o
...
$LD $LDFLAGS boot.o gdt.o idt.o "$RUST_LIB" -o kiki
...
${QEMU} -cdrom kernel.iso -machine pc $QEMUFLAGS -display sdl -no-reboot
EXIT=$?
