...
impl Keyboard {
    fn get_ascii(&self, scan_code: u8) -> char {
        ...
        match (key, shift_pressed, ctrl_pressed, alt_pressed) {
            ...
            (KeyboardKey::KeyEqual, false, false, false) => return '=',
            (KeyboardKey::KeyEqual, true, false, false) => return '+',
            (KeyboardKey::KeyEqual, _, true, false) => return '\0', // idk behavior
            (KeyboardKey::KeyEqual, _, false, true) => return '\0',
...
#[inline]
#[doc(hidden)]
/// input d'un port : recup ce que le clavier envoi
...
#[inline]
#[doc(hidden)]
/// output d'un port : envoyer des commandes au clavier ou interuption
