...
impl Keyboard {
    fn get_ascii(&self, scan_code: u8) -> char {
        ...
        match (key, shift_pressed, ctrl_pressed, alt_pressed) {
            ...
            (KeyboardKey::KeyEqual, false, false, false) =>  '=',
            (KeyboardKey::KeyEqual, true, false, false) =>  '+',
            (KeyboardKey::KeyEqual, _, true, false) =>  '\0', // idk behavior
            (KeyboardKey::KeyEqual, _, false, true) =>  '\0',
